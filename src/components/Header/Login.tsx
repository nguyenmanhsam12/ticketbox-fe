...
export default function Login( { onClose }: { onClose: () => void } ) {
  ...
  const [email, setEmail] = useState('bosamday1@gmail.com');
  ...
  return (
    <div className="flex justify-center items-center h-full w-full bg-[rgba(42,45,52,0.8)] fixed left-0 top-0 z-[999]">
      <div className="relative mx-8 rounded-xl bg-white h-auto w-full max-w-[400px]">
        {/* Close button */}
        <div className="absolute top-3 right-3 cursor-pointer z-10" onClick={onClose}>
        ...
        <div className="flex m-0 p-0 flex-col gap-0 items-stretch">
          ...
          <div className="bg-[#2dc275] h-[112px] relative w-full rounded-t-xl flex items-end">
            <div className="flex items-center gap-4 pb-5 pl-6 w-full">
              <span className="font-bold text-[28px] text-white leading-8">Đăng nhập</span>
          ...
          <div className="flex flex-col gap-4 pt-6 px-6 pb-6 bg-white rounded-b-xl">
            <form className="flex flex-col gap-4">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-[#2dc275] text-white font-semibold rounded-lg hover:bg-[#25a863] transition-colors"
              >
                Tiếp tục
              </button>
              ...
              <button
                type="button"
                className="w-full py-3 bg-[#4285f4] text-white font-medium rounded-lg hover:bg-[#3367d6] transition-colors flex items-center justify-center gap-2"
              >
                <svg width="18" height="18" viewBox="0 0 18 18">
                  <path fill="#4285F4" d="M16.51 8H8.98v3h4.3c-.18 1-.74 1.48-1.6 2.04v2.01h2.6a7.8 7.8 0 0 0 2.38-5.88c0-.57-.05-.66-.15-1.18z"/>
                  <path fill="#34A853" d="M8.98 17c2.16 0 3.97-.72 5.3-1.94l-2.6-2.01a4.8 4.8 0 0 1-2.7.75 4.32 4.32 0 0 1-4.07-2.98H1.96v2.07A7.68 7.68 0 0 0 8.98 17z"/>
                  <path fill="#FBBC04" d="M4.9 10.82a4.32 4.32 0 0 1 0-2.64V6.11H1.97a7.18 7.18 0 0 0 0 6.78l2.92-2.07z"/>
                  <path fill="#EA4335" d="M8.98 4.32c1.16 0 2.23.4 3.06 1.2l2.3-2.3A7.68 7.68 0 0 0 8.98 1 7.68 7.68 0 0 0 1.97 6.11l2.92 2.07A4.32 4.32 0 0 1 8.98 4.32z"/>
                </svg>
                Đăng nhập với tên Sam
              </button>
              
              <div className="text-xs text-gray-500 leading-relaxed">
                <span>nguyenmanhsam04@gmail.com</span>
              </div>
            </form>
            ...
            <div className="text-xs text-gray-500 leading-relaxed mt-2">
              ...
              <span className="text-[#2dc275] cursor-pointer hover:underline">Điều khoản sử dụng</span>
              {' '}và{' '}
              <span className="text-[#2dc275] cursor-pointer hover:underline">Chính sách bảo mật thông tin cá nhân</span>
              {' '}của Ticketbox
            </div>
          </div>
        </div>
